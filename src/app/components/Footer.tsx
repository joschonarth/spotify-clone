      ...
      <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between fixed bottom-0 left-0 right-0 z-10">
          <div className='flex items-center gap-3'>
              ...
              <div className='flex flex-col'>
                  <strong className='text-normal'>Murder on my Mind</strong>
                  <span className='text-xs text-zinc-400'>YNL Melly</span>
              </div>
          </div>
          ...
          <div className='flex flex-col items-center gap-2'>
            <div className='flex items-center gap-6'>
              ...
              <button className='w-10 h-10 flex items-center justify-center pl-1 rounded-full bg-white text-black'>
                <i className="fas fa-play"></i> {/* Ícone FontAwesome Play */}
              </button>
              ...
              <div className='flex items-center gap-2'>
                  ...
                  <span className='text-sx text-zinc-400'>2:41</span>
              </div>
          </div>
